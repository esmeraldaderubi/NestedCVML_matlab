...
%% Nested All data                                             %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [features_best, Measurements_test,classificationSVM_best,TableScores,TableFairnessbySex,TableFairnessbyAge,TableFairnessbySexAge] = TrainingFeatureTableNested(TableFeatures,fs_reduction, num_feats,removecorr,ismote,showGraphs)
        ...
        if(ismote)
            ...
            if(FairnessCompEnabled)
                if(outer_loop==1)
                    ...
                    matrixFairnessSexAge_All = zeros(size(FairnessStruct.fairnessSexAge,1),size(FairnessStruct.fairnessSexAge,2)-1);
                ...
                matrixFairnessSexAge_All = matrixFairnessSexAge_All+ FairnessStruct.fairnessSexAge(:,2:end);
                ...
                matrixFairnessSexAge_byloop = [FairnessStruct.fairnessSexAge; matrixFairnessSexAge_byloop];
            end
         ...
         if(FairnessCompEnabled)
             ...
             TableFairnessbySexAge = array2table(matrixFairnessSexAge_All./Num_it_outer);
             ...
             matrixFairnessSexAge_byloop = array2table(matrixFairnessAge_byloop);
             ...
             try
                ...
                TableFairnessbySexAge.Properties.VariableNames = {'StatisticalParityDifference', 'DisparateImpact', 'EqualOpportunityDifference', 'AverageAbsoluteOddsDifference','GroupCount', 'GroupSizeRatio','Accuracy','FalsePositiveRate','FalseNegativeRate' };
                ...
                matrixFairnessSexAge_byloop.Properties.VariableNames = {'Group','StatisticalParityDifference', 'DisparateImpact', 'EqualOpportunityDifference', 'AverageAbsoluteOddsDifference','GroupCount', 'GroupSizeRatio','Accuracy','FalsePositiveRate','FalseNegativeRate' };
                ...
                Measurements_test.TableFairnessSexAge_byloop = matrixFairnessSexAge_byloop;
             catch
